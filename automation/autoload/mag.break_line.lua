	...
	if style_name == "Tüm stiller" then style1 = 1 style2 = 1 end
		if subs[i].class == "dialogue" and comment1 == comment2 and style1 == style2 then
			...
			pcs = true
			c   = c + 1
			mag.progress("Satır bölmeleri kaldırılıyor...",c,total_line,true,300)
	...
	,{class = "checkbox", name = "u_comment_lines", value = c_comment_line,                     x = 1, y = 2, width = 1, height = 1, label = "Yorum satırlarını geç."}
	}
