	...
	in_lang["guiLabelKey10"]       = "Başlangıç animasyonu"
	in_lang["guiLabelKey11"]       = "Bitiş animasyonu"
	...
	in_lang["guiLabelKey30"]       = "Üst yazının puntosu:"
	in_lang["guiLabelKey31"]       = "Rumuz"
	in_lang["guiLabelKey32"]       = "Konum"
	in_lang["guiLabelKey33"]       = "Twitter"
	in_lang["guiLabelKey34"]       = "Discord"
	in_lang["guiLabelKey35"]       = "Site"
	in_lang["guiLabelKey36"]       = "{%s}. satır"
	in_lang["guiLabelKey37"]       = "Üst yazı şeffaflığı:"
	...
	in_lang["guiLabelKey10"]       = "Starting animation"
	in_lang["guiLabelKey11"]       = "Ending animation"
	...
	in_lang["guiLabelKey30"]       = "Size of top text:"
	in_lang["guiLabelKey31"]       = "Nickname"
	in_lang["guiLabelKey32"]       = "Position"
	in_lang["guiLabelKey33"]       = "Twitter"
	in_lang["guiLabelKey34"]       = "Discord"
	in_lang["guiLabelKey35"]       = "Site"
	in_lang["guiLabelKey36"]       = "Line {%s}"
	in_lang["guiLabelKey37"]       = "Top text opacity:"
	...
	gui                 = {
		main1 = {
		                      {class = "label",                                                        x = 1, y = 0,  width = 1, height = 1, label = c_lang.guiLabelKey31},
		                      {class = "label",                                                        x = 2, y = 0,  width = 1, height = 1, label = c_lang.guiLabelKey32},
		                      {class = "label",                                                        x = 3, y = 0,  width = 1, height = 1, label = c_lang.guiLabelKey33},
		                      {class = "label",                                                        x = 4, y = 0,  width = 1, height = 1, label = c_lang.guiLabelKey34},
		                      {class = "label",                                                        x = 5, y = 0,  width = 1, height = 1, label = c_lang.guiLabelKey35},
		...
		fontname             = {class = "edit",     name = "fontname",                                 x = 1, y = 0,  width = 1, height = 1},
		                       {class = "label",                                                       x = 0, y = 1,  width = 1, height = 1, label = c_lang.guiLabelKey30},
		toptextsize          = {class = "intedit",  name = "toptextsize",         min = 10, max = 200, x = 1, y = 1,  width = 1, height = 1},
		                       {class = "label",                                                       x = 0, y = 2,  width = 1, height = 1, label = c_lang.guiLabelKey13},
		nicksize             = {class = "intedit",  name = "nicksize",            min = 10, max = 200, x = 1, y = 2,  width = 1, height = 1},
		                       {class = "label",                                                       x = 0, y = 3,  width = 1, height = 1, label = c_lang.guiLabelKey14},
		sociallinkssize      = {class = "intedit",  name = "sociallinkssize",     min = 10, max = 200, x = 1, y = 3,  width = 1, height = 1},
		},
		main3 = {
		...
		shape_space          = {class = "intedit",  name = "shape_space",         min = 1, max = 100,  x = 1, y = 8,  width = 1, height = 1},
		...
		allshape_alphavalue  = {class = "intedit",  name = "allshape_alphavalue", min = 1, max = 100,  x = 1, y = 11, width = 1, height = 1},
				               {class = "label",                                                       x = 0, y = 12, width = 1, height = 1, label = c_lang.guiLabelKey37},
		toptext_alphavalue   = {class = "intedit",  name = "toptext_alphavalue",  min = 1, max = 100,  x = 1, y = 12, width = 1, height = 1},
				               {class = "label",                                                       x = 0, y = 13, width = 1, height = 1, label = c_lang.guiLabelKey26},
		blurvalue            = {class = "edit",     name = "blurvalue",                                x = 1, y = 13, width = 1, height = 1},
				               {class = "label",                                                       x = 0, y = 14, width = 1, height = 1, label = c_lang.guiLabelKey25},
		fadvalue             = {class = "intedit",  name = "fadvalue",            min = 0, max = 500,  x = 1, y = 14, width = 1, height = 1},
		                       {class = "label",                                                       x = 0, y = 16, width = 1, height = 1, label = c_lang.guiLabelKey28},
				               {class = "label",                                                       x = 0, y = 17, width = 1, height = 1, label = c_lang.guiLabelKey29},
		linenumber           = {class = "intedit",  name = "linenumber",          min = 1, max = 20,   x = 1, y = 17, width = 1, height = 1},
		}
	}
	end

	function newtranslator(n)
	local gui = {}
	gui["translator"..n.."_select"]  = {class = "checkbox", name = "translator"..n.."_select",  x = 0, y = n, width = 1, height = 1, label = mag.string.format(c_lang.guiLabelKey36, n)}
	gui["translator"..n.."_name"]    = {class = "edit",     name = "translator"..n.."_name",    x = 1, y = n, width = 1, height = 1}
	gui["translator"..n.."_etext"]   = {class = "edit",     name = "translator"..n.."_etext",   x = 2, y = n, width = 1, height = 1}
	gui["translator"..n.."_twitter"] = {class = "edit",     name = "translator"..n.."_twitter", x = 3, y = n, width = 1, height = 1}
	gui["translator"..n.."_discord"] = {class = "edit",     name = "translator"..n.."_discord", x = 4, y = n, width = 1, height = 1}
	gui["translator"..n.."_site"]    = {class = "edit",     name = "translator"..n.."_site",    x = 5, y = n, width = 1, height = 1}
	return gui
	end
	...
	local i    = 0
	for k = 1, 10 do
		if c["translator"..k.."_select"] and not mag.is.empty(c["translator"..k.."_name"]) then
		i                                                                   = i +  1
		data.count                                                          = data.count + 1
		data["translator"..i]                                               = {}
		data["translator"..i].nick                                          = {}
		data["translator"..i].nick.width, data["translator"..i].nick.height = getsize(line.styleref, c.fontname, c.nicksize, c["translator"..k.."_name"])
		data["translator"..i].nick.text                                     = c["translator"..k.."_name"]
		data["translator"..i].shapewidth                                    = data["translator"..i].nick.width
		data["translator"..i].shapeheight                                   = data["translator"..i].nick.height
			if not mag.is.empty(c["translator"..k.."_twitter"]) then
			data["translator"..i].twitter                                             = {}
			data["translator"..i].twitter.width, data["translator"..i].twitter.height = getsize(line.styleref, c.fontname, c.sociallinkssize, c["translator"..k.."_twitter"])
			data["translator"..i].twitter.text                                        = c["translator"..k.."_twitter"]
			...
			data["translator"..i].shapewidth                                          = whichoneisbigger(data["translator"..i].shapewidth, data["translator"..i].twitter.width + data["translator"..i].twitter.height + c.padding)
			data["translator"..i].shapeheight                                         = data["translator"..i].shapeheight + data["translator"..i].twitter.height + c.padding + (c.padding / 2)
			end
			if not mag.is.empty(c["translator"..k.."_discord"]) then
			data["translator"..i].discord                                             = {}
			data["translator"..i].discord.width, data["translator"..i].discord.height = getsize(line.styleref, c.fontname, c.sociallinkssize, c["translator"..k.."_discord"])
			data["translator"..i].discord.text                                        = c["translator"..k.."_discord"]
			...
			data["translator"..i].shapewidth                                          = whichoneisbigger(data["translator"..i].shapewidth, data["translator"..i].discord.width + data["translator"..i].discord.height + c.padding)
			data["translator"..i].shapeheight                                         = data["translator"..i].shapeheight + data["translator"..i].discord.height + c.padding + (c.padding / 2)
			end
			if not mag.is.empty(c["translator"..k.."_site"]) then
			data["translator"..i].site                                          = {}
			data["translator"..i].site.width, data["translator"..i].site.height = getsize(line.styleref, c.fontname, c.sociallinkssize, c["translator"..k.."_site"])
			data["translator"..i].site.text                                     = c["translator"..k.."_site"]
			...
			data["translator"..i].shapewidth                                    = whichoneisbigger(data["translator"..i].shapewidth, data["translator"..i].site.width + data["translator"..i].site.height + c.padding)
			data["translator"..i].shapeheight                                   = data["translator"..i].shapeheight + data["translator"..i].site.height + c.padding + (c.padding / 2)
			end
			if not mag.is.empty(c["translator"..k.."_etext"]) then
			data["translator"..i].etext                                           = {}
			data["translator"..i].etext.width, data["translator"..i].etext.height = getsize(line.styleref, c.fontname, c.toptextsize, c["translator"..k.."_etext"])
			data["translator"..i].etext.text                                      = c["translator"..k.."_etext"]
			data["translator"..i].shapewidth                                      = whichoneisbigger(data["translator"..i].shapewidth, data["translator"..i].etext.width)
			data["translator"..i].shapeheight                                     = data["translator"..i].shapeheight + data["translator"..i].etext.height + c.padding * 2 + 2
			end
		data["translator"..i].shapewidth  = data["translator"..i].shapewidth + c.padding * 2
		data["translator"..i].shapeheight = data["translator"..i].shapeheight + c.padding * 2
		end
	end
	data = sortdata(data)
	return data
	...
	if data.count == 0 then return data end
	local keys        = {}
	local index_table = {}
	for i = 1, data.count do
	mag.array.insert(keys, data["translator"..i].nick.text)
	index_table[data["translator"..i].nick.text] = i
	end
	mag.sort.basic(keys)
	local newdata = {}
	for k, val in pairs (keys) do
	newdata["translator"..k] = data["translator"..index_table[val]]
	end
	...
	local maxwidth = 0
	for i = 1, data.count do maxwidth = whichoneisbigger(maxwidth, data["translator"..i].shapewidth) end
	return maxwidth
	end
	...
	temp_height                   = data["translator"..number].site.height + c.padding
	temp_posy                     = temp_posy - c.padding * 1.5 - data["translator"..number].site.height
	temp_width                    = data["translator"..number].site.width + c.padding + data["translator"..number].site.height
	shape                         = shape .. " " .. shaper(temp_width, temp_height, temp_posx, temp_posy, 5)
	end
	if data["translator"..number].discord ~= nil then
	temp_height                   = data["translator"..number].discord.height + c.padding
	temp_posy                     = temp_posy - c.padding * 1.5 - data["translator"..number].discord.height
	temp_width                    = data["translator"..number].discord.width + c.padding + data["translator"..number].discord.height
	shape                         = shape .. " " .. shaper(temp_width, temp_height, temp_posx, temp_posy, 5)
	end
	if data["translator"..number].twitter ~= nil then
	temp_height                   = data["translator"..number].twitter.height + c.padding
	temp_posy                     = temp_posy - c.padding * 1.5 - data["translator"..number].twitter.height
	temp_width                    = data["translator"..number].twitter.width + c.padding + data["translator"..number].twitter.height
	shape                         = shape .. " " .. shaper(temp_width, temp_height, temp_posx, temp_posy, 5)
	end
	...
	line.text                     = mag.string.format("{\\c{%s}\\bord0\\shad0\\fscx100\\fscy100\\an5{%s}\\p1\\blur{%s}\\alpha&H{%s}&}{%s}", shapecolor, animation, c.blurvalue, mag.convert.alpha_from_percent(c.allshape_alphavalue, true), shape)
	c_lcounter                    = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	if data["translator"..number].etext ~= nil then
	line.actor                    = mag.string.format(c_lang.actorformat, number, c_lang.actorKey2)
	temp_posx                     = (posx + c.shape_space + c.border_thickness) - width / 2 + data["translator"..number].etext.width / 2 + c.padding
	temp_posy                     = (posy + c.shape_space + c.border_thickness) - height / 2 + data["translator"..number].etext.height / 2 + c.padding
	animation                     = animator(temp_posx, temp_posy, true)
	line.text                     = mag.string.format("{\\c{%s}\\alpha&{%s}&\\bord0\\shad0\\an5{%s}\\fs{%s}\\fn{%s}\\blur{%s}}{%s}", textcolor, mag.convert.alpha_from_percent(c.toptext_alphavalue, true), animation, c.toptextsize, c.fontname, c.blurvalue, data["translator"..number].etext.text)
	c_lcounter                    = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	line.actor                    = mag.string.format(c_lang.actorformat, number, c_lang.actorKey2)
	temp_posx                     = (posx + c.shape_space + c.border_thickness)
	temp_posy                     = (posy + c.shape_space + c.border_thickness) - height / 2 + c.padding * 2 + data["translator"..number].etext.height + 2
	animation                     = animator(temp_posx, temp_posy, true)
	line.text                     = mag.string.format("{\\c{%s}\\bord0\\shad0\\an5{%s}\\p1\\blur{%s}\\alpha&H{%s}&}{%s}", "&HFFFFFF&", animation, c.blurvalue, mag.convert.alpha_from_percent(c.toptext_alphavalue, true), shaper(width, 2, 0, 0, 0))
	c_lcounter                    = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	end
	line.actor                    = mag.string.format(c_lang.actorformat, number, c_lang.actorKey2)
	...
	if data["translator"..number].etext ~= nil then
	temp_posy                     = temp_posy + c.padding * 2 + data["translator"..number].etext.height
	end
	animation                     = animator(temp_posx, temp_posy, true)
	line.text                     = mag.string.format("{\\c{%s}\\bord0\\shad0\\an5{%s}\\fs{%s}\\fn{%s}\\blur{%s}}{%s}", textcolor, animation, c.nicksize, c.fontname, c.blurvalue, data["translator"..number].nick.text)
	c_lcounter                    = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	if data["translator"..number].site ~= nil or data["translator"..number].discord ~= nil or data["translator"..number].twitter ~= nil then
	temp_posy                     = (posy + c.shape_space + c.border_thickness) + height / 2 + c.sociallinkssize / 2
	end
	if data["translator"..number].site ~= nil then
	...
	temp_posy                     = temp_posy - data["translator"..number].site.height - c.padding * 1.5
	...
	temp_posy                     = temp_posy - data["translator"..number].discord.height - c.padding * 1.5
	animation                     = animator(temp_posx, temp_posy, false)
	...
	temp_posy                     = temp_posy - data["translator"..number].twitter.height - c.padding * 1.5
	animation                     = animator(temp_posx, temp_posy, false)
	...
	local round                   = 0
	local count                   = 0
	local fullshapeheight         = 0
	local startpoint_x, startpoint_y, frzval, animation
	for i = 1, data.count do
	fullshapeheight = fullshapeheight + data["translator"..i].shapeheight + c.shape_space * (i - 1)
	end
	if data.count == 0 then
	mag.show.log(1, c_lang.errorKey1)
	elseif hw > fullshapeheight then
	...
	mag.show.log(1, c_lang.errorKey3)
		...
		for i = 1, data.count do startpoint_y = startpoint_y - data["translator"..i].shapeheight end
		temp = height
		posy = startpoint_y
	...
	animation                         = animator(temp_posx, temp_posy, true)
	line.text                         = mag.string.format("{\\c&H{%s}&\\bord0\\shad0\\fscx100\\fscy100\\an5{%s}\\p1\\blur{%s}\\alpha&H{%s}&}{%s}", shapecolor, animation, c.blurvalue, mag.convert.alpha_from_percent(c.allshape_alphavalue, true), shape)
	c_lcounter                        = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	...
	animation                         = animator(temp_posx, temp_posy, true)
	line.text                         = mag.string.format("{\\c{%s}\\bord0\\shad0\\an5{%s}\\fs{%s}\\fn{%s}\\frz{%s}\\blur{%s}\\alpha&H{%s}&}{%s}", shapecolor, animation, mag.floor(headersize), c.fontname, frzval, c.blurvalue, mag.convert.alpha_from_percent(c.allshape_alphavalue, true), c.header_text)
	c_lcounter                        = c_lcounter + 1
	subs.insert(act + c_lcounter, line)
	end
	end
	...
	local ok, config, yoff
	if gui1_loaded == false then
	yoff                         = 12
	...
	for i = 1, 10 do gui.main1 = mag.array.merge(gui.main1, newtranslator(i), true) end
	gui1_loaded                  = true
	end
	repeat
	...
	if c["translator1_select"] == nil then
		for i = 1, 10 do
		c["translator"..i.."_select"]  = true
		c["translator"..i.."_etext"]   = ""
		c["translator"..i.."_name"]    = ""
		c["translator"..i.."_twitter"] = ""
		c["translator"..i.."_discord"] = ""
		c["translator"..i.."_site"]    = ""
		end
	end
	if c_lock_gui then
